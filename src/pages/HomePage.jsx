...
export default function HomePage({ isSidebarOpen, setIsSidebarOpen }) {
  return (
    <section className="p-6 lg:p-8 overflow-y-auto">
      ...
      >
        <h1 className="text-[#f8f7f7] font-bold font-[Inter]">Your Next Developer Is Right Here — Dive Into My Work</h1>
      </motion.h1>
      ...
      <div className="mt-8 flex gap-8 flex-wrap justify-center lg:justify-start">
        <About />
        <TechStackCard />
      </div>
    </section>
